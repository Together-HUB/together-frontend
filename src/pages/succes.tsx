...
export default function SuccesPage() {
  return (
    <>
      <Head>
        <title>Histoires de succès — ToGETHER Networking</title>
          ...
          <div className="max-w-lg w-full text-center">
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-10">
              ...
              <p className="text-gray-500 leading-relaxed">
                Cette section mettra en lumière les réalisations concrètes des ONG membres du réseau — des témoignages de terrain, des chiffres d&apos;impact réels et des récits qui illustrent la force du leadership humanitaire local.
              </p>
              ...
              <div className="text-left space-y-3 mb-8">
                {[
                  "Témoignages de bénéficiaires et de communautés aidées",
                  "Chiffres d'impact documentés et vérifiés",
                  "Études de cas par secteur et par province",
                  "Portraits des organisations membres du réseau",
                ].map((item, i) => (
