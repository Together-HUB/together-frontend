          ...
          {CARDS.map((card, i) => {
            const cardContent = (
              <motion.div
                ...
                className="bg-white rounded-xl p-6 border border-gray-100 hover:shadow-lg hover:-translate-y-1 hover:border-primary/20 transition-all duration-200 ease-in-out cursor-pointer group h-full"
              >
                <div
